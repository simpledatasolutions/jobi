...
@section('title')
<title>Apply | Jobi Tax</title>
@endsection

@section('is-active-apply')
class="active"
@endsection
...
<div id="apply-page">
    ...
    <div class="container-sm">
        <div class="offset-md-3 col-md-7 applyFormCol">
            <form id="applyForm">
                <div class="card">
                    <div class="card-body cardHeader">
                        ...
                        <p>Jobi is group of Accountants, Engineers and Computer Scientists who believe the current way that tax is done and lodged is outdated and riddled with human error. Our studies indicate that 70% of immigrants and student tax returns can be automated. This allows you to save on
                            consulting an Accountant and providing the best possible tax refund for your unique situation. </p>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <br><br>
                        <input type="text" name="phone" placeholder="Your answer">
                    </div>
                </div><br>
                <div class="card">
                    <div class="card-body">
                        <label>County Of Origin <span style="color:red;">*</span></label>
                        <br><br>
                        <select name="origin">
